...
class Pointing:
    def __init__(self, table_length_actual = 1.6, table_width_actual = 1.6, table_height_actual = 0.65):    
        ...
        self.px_per_meter = 221/self.table_depth_m # pixels per meter at distance table_depth
        #Transform meters into pixels
        self.table_depth = 221 #(in pixels)
        ...
        self.point_limit_bottom_r = self.table_depth
        self.point_limit_bottom_l = self.table_depth
        ...
        def animate(i):
            ...
            if self.cal.calibrated:
                ...
                ax.plot((-self.rpoint[0]/self.point_limit_right_r),
                        ...
                        'ro', label='right', markersize= 20)
                ax.text(1, 1,"Left: %.1f %.1f\nRight: %.1f %.1f" %(self.lpoint[0], self.lpoint[1], self.rpoint[0], self.rpoint[1]), fontsize=15, horizontalalignment='center', verticalalignment='center')
                ax.legend()
                ...
                if interval < 10:
                    ...
                    print(self.point_limit_top_r, self.point_limit_top_l, self.point_limit_bottom_r, self.point_limit_bottom_l, self.point_limit_left_l, self.point_limit_right_r)
                    # For testing
